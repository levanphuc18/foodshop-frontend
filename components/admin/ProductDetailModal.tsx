        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-slate-100 dark:border-slate-800">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Product ID: {product.productId}</span>
            </div>
            <h2 className="text-xl font-black text-slate-900 dark:text-white leading-tight">Product Insights</h2>
          </div>
        ...
        <div className="p-8 max-h-[70vh] overflow-y-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div>
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-sky-600 mb-1 block">General Information</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1">Inventory</span>
                  <p className="text-sm font-black text-slate-900 dark:text-white">{product.quantity} Units</p>
                </div>
              </div>

              <div>
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-sky-600 mb-1 block">Description</label>
                <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                  {product.description || 'No description provided for this preservation.'}
                </p>
              </div>
            </div>
          </div>
